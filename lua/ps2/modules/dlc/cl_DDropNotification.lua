...
function PANEL:Init( )
	...
	self.lbl:SetText( "You received a drop!" )
...
vgui.Register( "DDropNotification", PANEL, "DPanel" )

Pointshop2View:include({
    showDropsNotification = function( self, item )
        local notification = vgui.Create( "DDropNotification" )
